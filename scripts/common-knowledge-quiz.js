...
const questions = [
  {
    image: "/imk-v1/assets/animal/kucing2.svg",
  ...
  {
    image: "/imk-v1/assets/animal/kucing1.svg",
    question: "Apa nama hewan ini?",
    answers: [
      { text: "Anjing", correct: false },
...
function showFinalScore() {
 ...
 if (percentage === 100) {
   ...
   trophyImage.src = "/imk-v1/assets/silver-trophy.svg";
 } else if (percentage >= 60) {
   message = "Bagus! Kamu sudah hampir menguasainya! 👍";
   trophyImage.src = "/imk-v1/assets/bronze-trophy.svg";
 } else {
   message = "Jangan menyerah, terus belajar! 💪";
   trophyImage.src = "/imk-v1/assets/participation-trophy.svg";
 }
